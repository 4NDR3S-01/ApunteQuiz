    ...
    accessibility: {
      ...
      toasts: {
        voiceControl: {
          ...
          networkRetry: 'Error de red detectado. Reintentando...',
          networkRetryStatus: 'Error de red detectado. Reintentando... ({attempt}/{max})',
    ...
    accessibility: {
      ...
      toasts: {
        voiceControl: {
          ...
          networkRetry: 'Network error detected. Retrying...',
          networkRetryStatus: 'Network error detected. Retrying... ({attempt}/{max})',
