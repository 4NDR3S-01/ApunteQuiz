const translations = {
  es: {
    ...
    faqPage: {
      ...
      shortcutsDescription: 'Usa estos atajos para navegar más rápido por la aplicación:',
      shortcuts: [
        { combo: '/', label: 'Abrir búsqueda' },
        { combo: 'Alt + 1', label: 'Ir a Inicio' },
        { combo: 'Alt + 2', label: 'Ir a FAQ' },
        { combo: 'Alt + 3', label: 'Ir a Contacto' },
        { combo: 'Esc', label: 'Cerrar menú / cancelar' },
  ...
  en: {
    ...
    faqPage: {
      ...
      shortcutsDescription: 'Use these shortcuts to navigate through the app faster:',
      shortcuts: [
        { combo: '/', label: 'Open search' },
        { combo: 'Alt + 1', label: 'Go to Home' },
        { combo: 'Alt + 2', label: 'Go to FAQ' },
        { combo: 'Alt + 3', label: 'Go to Contact' },
        { combo: 'Esc', label: 'Close menu / cancel' },
